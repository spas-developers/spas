...
public class DepartmentsController {
	...
	ResponseEntity<?> addDepartment(@RequestBody Department department) {
		 try { 
			 Department addedDepartment = departmentsDelegate.addDepartment(department); 
			 ResponseEntity<Department> responseEntity = new ResponseEntity<Department>(addedDepartment, HttpStatus.OK); 
			 return responseEntity;
