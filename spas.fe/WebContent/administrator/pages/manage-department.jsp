        ...
        <table class="list-table">
            ...
            <% 
                ...
                for (int i=0;i < departments.size();i++) {
                    out.println("<tr>");
                    out.println("<td>" + departments.get(i).getDepartmentID() + "</td>");
                    out.println("<td>" + departments.get(i).getDepartmentName() + "</td>");
                    out.println("<td>" + departments.get(i).getAbbreviation() + "</td>");
                    out.println("</tr>");
                }
            %>
        </table>
            ...
            <div id="id01" class="w3-modal">
                <div class="w3-modal-content">
                    <div class="w3-container">
                        ...
                        <form action="manageDepartment" class="centered" method="POST">
                            <table>
                                ...
                                <div class="centered">
                                    <button class="w3-button w3-black add-button" name="addDepartmentButton">Add Department</button>
                                </div>
                        </form>
                    </div>
                </div>
